...
<div class="pageheader">
    ...
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            <li><?php echo $this->Html->link('Add New User', array('controller' => 'Users', 'action' => 'add'), array('class' => 'btn btn-primary btn-s')); ?></li>
        </ol>
    </div>
</div>
            ...
            <tbody>
                ...
                if (is_array($users)) {
                    foreach ($users as $user) { 
                        ...
                        (["controller" => "UsersCourses","action" => "index",$user->id]). "'>View</a></td>";
                        $Listing .= '</tr>';
                    }
                } else {
